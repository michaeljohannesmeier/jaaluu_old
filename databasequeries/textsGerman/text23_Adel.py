...
headline1='''  Gibt es heute noch den Adel? '''

paragraph1='''In manchen Ländern in Europa gibt es immer noch einen Adel. Diese Länder haben sogar ein adeliges Staatsoberhaupt: in Belgien zum Beispiel ist es ein König, in Liechtenstein ein Fürst. Die übrigen Adeligen in diesen Ländern haben aber normalerweise kaum noch Vorrechte.
