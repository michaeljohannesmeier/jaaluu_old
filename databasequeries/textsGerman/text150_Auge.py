...
paragraph0='''Das Auge ist ein Sinnesorgan, mit dem man sehen kann. Die meisten Wirbeltiere haben zwei Augen, also auch wir Menschen. Es gibt auch ein paar Tiere, die mehr Augen als wir haben und Tiere, die weniger Augen haben. 
...
headline1=''' Welche Arten von Augen gibt es?'''

paragraph1='''Die Biologen unterscheiden zwischen etwa sieben verschiedenen Arten von Augen. Der Regenwurm und einige andere Tiere haben die einfachsten Augen: Es sind einzelne Zellen auf der Haut, die Hell und Dunkel unterscheiden können. Durch die Lage am Körper kann der Regenwurm erkennen, woher die Helligkeit kommt.
...
headline2='''  Wie funktioniert das Sehen mit einem Wirbeltierauge? '''

paragraph2='''Das Auge des Menschen ist in der Biologie ein Wirbeltierauge. Es liegt in der Augenhöhle. Dies ist ein fast kugelrundes Loch im Schädel. Die Wände bestehen aus Knochen. Dort drin liegt der Augapfel. Er ist gefüllt mit einem dickflüssigen Material. Der heißt Glaskörper, weil er durchsichtig ist wie Glas.
...
headline3='''  Wie funktioniert das Sehen mit einem Facettenauge? '''

paragraph3='''Ein Facettenauge besteht aus vielen einzelnen Augen. Sie bilden gemeinsam ein Muster wie bei einer Bienenwabe. Die Oberfläche ist fast wie eine Halbkugel, deshalb blickt jedes Auge ein wenig in eine andere Richtung. Jedes Auge kann nur einen einzelnen Bildpunkt erfassen. Das ist wie bei einem Bildschirm mit vielen einzelnen Pixeln.
